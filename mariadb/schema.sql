...
CREATE TABLE IF NOT EXISTS `energy` (
  ...
  `sph_grid_power_w`                    double       DEFAULT NULL COMMENT 'Growatt reg 35 REG_AC_POWER_H: unsigned inverter AC output W (NOT net grid; see sph_grid_meter_power_w)',
  `sph_grid_meter_power_w`              double       DEFAULT NULL COMMENT 'Growatt reg 31112 REG_AC_METER_POWER: signed net grid W (+import, -export), meter read in the same 60s poll as PV/battery so the flow diagram balances',
